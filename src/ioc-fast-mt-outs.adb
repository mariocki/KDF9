...
package body IOC.fast.MT.OUTs is
   ...
   begin
      ...
      begin
         find_tape(MT.data_storage(label), B, W, "OUT 4");  -- W is not actually used in OUT 4
         push(KDF9.word(B));
   ...
   begin
      ...
      begin
         find_tape(MT.data_storage(label), B, w, "OUT 10");
         push(W);
         push(KDF9.word(B));
         the_trace_operand := KDF9.word(B);
